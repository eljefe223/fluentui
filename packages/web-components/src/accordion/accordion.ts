...
import { AccordionItem, BaseAccordionItem } from '../accordion-item/accordion-item.js';
...
export class Accordion extends FASTElement {
  ...
  private findExpandedItem(): BaseAccordionItem | Element | null {
    ...
    return (
      this.accordionItems.find((item: Element | BaseAccordionItem) => item instanceof AccordionItem && item.expanded) ??
