...
import type { DialogBody as KumoDialogBody } from '../../dialog-body/dialog-body.js';

type DialogStoryArgs = Args & KumoDialogBody;
...
export default {
  title: 'Components/Kumo/Dialog/Dialog Body',
  argTypes: {
    noTitleAction: {
      description:
...
export const Basic = renderComponent(html<DialogStoryArgs>`
  <kumo-dialog-body>
    ...
    <kumo-button slot="action">Close Dialog</kumo-button>
    <kumo-button appearance="primary" slot="action">Call to Action</kumo-button>
  </kumo-dialog-body>
`);

export const Actions = renderComponent(html<DialogStoryArgs>`
  <kumo-dialog-body id="dialog-fluidactions">
    <div slot="title">Actions</div>
    <kumo-button appearance="transparent" icon-only slot="title-action"> ${dismissed20Regular} </kumo-button>
    <div>
      <fluent-text block>
        <p>
    ...
    <kumo-button slot="action" size="small" appearance="primary">Close Dialog</kumo-button>
