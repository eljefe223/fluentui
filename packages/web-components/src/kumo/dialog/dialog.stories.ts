...
import type { Dialog as KumoDialog } from '../../dialog/dialog.js';
import { DialogType } from '../../dialog/dialog.options.js';

type DialogStoryArgs = Args & KumoDialog;
...
const closeDialog = (e: Event, id: string, dismissed: boolean = false) => {
  const dialog = document.getElementById(id) as KumoDialog;
  dialog.hide();
};
...
const dialogTemplate = html<DialogStoryArgs>`
  ...
  <div>
    <kumo-button @click=${(e: Event, c) => openDialog(e, 'dialog-default')}>Open Dialog</kumo-button>
    <kumo-dialog id="dialog-default" type="${x => x.type}" ?no-title-action="${x => x.noTitleAction}">
      <kumo-dialog-body>
        ...
        <br />
        <fluent-text block><code>kumo-dialog</code></fluent-text>
        <kumo-button
          id="dialog-default-close"
          slot="action"
          appearance="primary"
          @click="${(e: Event, c) => closeDialog(e, 'dialog-default')}"
          >Close Dialog</kumo-button
        >
        <kumo-button id="dialog-default-dosomething" slot="action" tabindex="0">Do Something</kumo-button>
      </kumo-dialog-body>
    </kumo-dialog>
  </div>
`;
...
export default {
  title: 'Components/Kumo/Dialog/Dialog',
  args: {
...
export const Modal = renderComponent(html<DialogStoryArgs>`
  <div>
    ...
    <br />
    <kumo-button @click=${(e: Event) => openDialog(e, 'dialog-modal')}>Open Dialog</kumo-button>
    <kumo-dialog id="dialog-modal" type="${DialogType.modal}">
      <kumo-dialog-body>
        ...
        <kumo-button slot="action" appearance="primary" @click="${(e: Event, c) => closeDialog(e, 'dialog-modal')}"
          >Close Dialog</kumo-button
        >
        <kumo-button slot="action">Do Something</kumo-button>
      </kumo-dialog-body>
    </kumo-dialog>
  </div>
`);
...
export const NonModal = renderComponent(html<DialogStoryArgs>`
  <div>
    ...
    <kumo-button @click=${(e: Event) => openDialog(e, 'dialog-nonmodal')}>Open Dialog</kumo-button>
    <kumo-dialog id="dialog-nonmodal" type="${DialogType.nonModal}">
      <kumo-dialog-body>
        ...
        <fluent-text block><code>type="non-modal"</code></fluent-text>
        <kumo-button slot="action" appearance="primary" @click="${(e: Event, c) => closeDialog(e, 'dialog-nonmodal')}">
          Close Dialog
          </kumo-button>
        <kumo-button slot="action">Do Something</kumo-button>
      </kumo-dialog-body>
...
export const Alert = renderComponent(html<DialogStoryArgs>`
  <div>
    ...
    <br />
    <kumo-button @click=${(e: Event) => openDialog(e, 'dialog-alert')}>Open Dialog</kumo-button>
    <kumo-dialog id="dialog-alert" type="${DialogType.alert}">
      <kumo-dialog-body>
        ...
        <kumo-button slot="action" appearance="primary" @click="${(e: Event, c) => closeDialog(e, 'dialog-alert')}"
          >Close Dialog</kumo-button
        >
        <kumo-button slot="action">Do Something</kumo-button>
      </kumo-dialog-body>
...
export const Actions = renderComponent(html<DialogStoryArgs>`
  <div>
    ...
    <br />
    <kumo-button @click=${(e: Event) => openDialog(e, 'dialog-fluidactions')}>Open Dialog</kumo-button>
    <kumo-dialog id="dialog-fluidactions">
      <kumo-dialog-body>
        ...
        <kumo-button size="small" slot="action">Something</kumo-button>
        <kumo-button size="small" slot="action">Something Else</kumo-button>
        ...
        <kumo-button
          ...
          >Close Dialog</kumo-button
        >
        <kumo-button size="small" slot="action">Something Else Entirely</kumo-button>
      </kumo-dialog-body>
    </kumo-dialog>
  </div>
`);
  ...
  <div>
    ...
    <fluent-text block>
      <span>
        ...
        ignoring the type property, here's an example replacing the simple close icon with a kumo button using a
        different icon.
      </span>
    </fluent-text>
    <br />
    ...
    <br />
    <kumo-button @click=${(e: Event) => openDialog(e, 'dialog-titlecustomaction')}>Open Dialog</kumo-button>
    <kumo-dialog id="dialog-titlecustomaction">
      <kumo-dialog-body>
        ...
        <fluent-text block>
          <span>
            ...
            dialog, ignoring the type property, here's an example replacing the simple close icon with a kumo button
...
export const NoTitleAction = renderComponent(html<DialogStoryArgs>`
  <div>
    ...
    <br />
    <kumo-button @click=${(e: Event) => openDialog(e, 'dialog-notitleaction')}>Open Dialog</kumo-button>
    <kumo-dialog id="dialog-notitleaction" type="${DialogType.nonModal}">
      <kumo-dialog-body no-title-action>
...
export const TwoColumnLayout = renderComponent(html<DialogStoryArgs>`
  <div>
    ...
    >
    <br />
    <kumo-button @click=${(e: Event) => openDialog(e, 'dialog-twocolumn')}>Open Dialog</kumo-button>
    <kumo-dialog id="dialog-twocolumn" type="${DialogType.nonModal}">
      <kumo-dialog-body>
        ...
        <kumo-button slot="action" @click="${(e: Event, c) => closeDialog(e, 'dialog-twocolumn', true)}"
          >Cancel</kumo-button
        >
        <kumo-button appearance="primary" slot="action">Sign Up</kumo-button>
      </kumo-dialog-body>
    </kumo-dialog>
  </div>
`);
...
export const ImageAndText = renderComponent(html<DialogStoryArgs>`
  <div>
    ...
    >
    <br />
    <kumo-button @click=${(e: Event) => openDialog(e, 'dialog-image')}>Open Dialog</kumo-button>
    <kumo-dialog id="dialog-image" type="${DialogType.nonModal}">
      <fluent-image block>
      ...
      <kumo-dialog-body>
        ...
        <kumo-button slot="action" @click="${(e: Event, c) => closeDialog(e, 'dialog-image', true)}"
          >Cancel</kumo-button
        >
        <kumo-button appearance="primary" slot="action">Sign Up</kumo-button>
      </kumo-dialog-body>
...
export const ModalWithNoTitleOrActions = renderComponent(html<DialogStoryArgs>`
  <div>
    ...
    <br />
    <kumo-button @click=${(e: Event) => openDialog(e, 'dialog-notitleactions')}>Open Dialog</kumo-button>
    <kumo-dialog id="dialog-notitleactions">
      <kumo-dialog-body>
        <fluent-text block
...
export const NonModalWithNoTitleOrActions = renderComponent(html<DialogStoryArgs>`
  <div>
    ...
    >
    <br />
    <kumo-button @click=${(e: Event) => openDialog(e, 'dialog-nonmodalnotitleactions')}>Open Dialog</kumo-button>
    <kumo-dialog id="dialog-nonmodalnotitleactions" type="${DialogType.nonModal}">
      <kumo-dialog-body>
        <fluent-text block
          ><p>
...
export const RTL = renderComponent(html<DialogStoryArgs>`
  <div>
    ...
    >
    <br />
    <kumo-button @click=${(e: Event) => openDialog(e, 'dialog-rtl')}>Open Dialog</kumo-button>

    <kumo-dialog id="dialog-rtl" type="${DialogType.modal}" dir="rtl">
      <kumo-dialog-body>
        ...
        <kumo-button slot="action" @click="${(e: Event, c) => closeDialog(e, 'dialog-rtl', true)}">إلغاء</kumo-button>
        <kumo-button appearance="primary" slot="action">قم بشيء</kumo-button>
      </kumo-dialog-body>
    </kumo-dialog>
  </div>
`);
...
export const ScrollingLongContent = renderComponent(html<DialogStoryArgs>`
  <div>
    ...
    >
    <br />
    <kumo-button @click=${(e: Event) => openDialog(e, 'dialog-longcontent')}>Open Dialog</kumo-button>
    <kumo-dialog id="dialog-longcontent">
      <fluent-image block>
        <img alt="image layout story" src="https://picsum.photos/600/400" />
      </fluent-image>
      <kumo-dialog-body>
