...
import type { MenuList as KumoMenuList } from '../../menu-list/menu-list.js';

type MenuListStoryArgs = Args & KumoMenuList;
...
const storyTemplate = html<MenuListStoryArgs>`
  <div style="width: 200px;">
    <kumo-menu-list>
      <kumo-menu-item ?disabled=${x => x.disabled}>
        Item 1
      ...
      <kumo-menu-item ?disabled=${x => x.disabled}> Open </kumo-menu-item>

      <kumo-menu-item disabled="true">
      ...
      <kumo-menu-item role="menuitemcheckbox" ?disabled=${x => x.disabled}>
        Checkbox 1
      ...
      <kumo-menu-item role="menuitemcheckbox" ?disabled=${x => x.disabled}> Checkbox 3 </kumo-menu-item>

      <fluent-divider role="separator" aria-orientation="horizontal" orientation="horizontal"></fluent-divider>

      <kumo-menu-item role="menuitemradio" ?disabled=${x => x.disabled}>
        Radio 1
        <span slot="start">${Cut20Filled}</span>
      </kumo-menu-item>
      ...
      <kumo-menu-item role="menuitemradio" ?disabled=${x => x.disabled}> Radio 3 </kumo-menu-item>
...
export default {
  title: 'Components/Kumo/MenuList',
  args: {
    disabled: false,
  },
  argTypes: {
...
export const MenuListWithCheckboxSelection = renderComponent(html<MenuListStoryArgs>`
  <div style="width: 128px;">
    <kumo-menu-list>
      <kumo-menu-item role="menuitemcheckbox"> Item 1 </kumo-menu-item>
...
export const MenuListWithRadioSelection = renderComponent(html<MenuListStoryArgs>`
  <div style="width: 128px; position: relative">
    <kumo-menu-list>
      <kumo-menu-item role="menuitemradio"> Item 1 </kumo-menu-item>
      <kumo-menu-item role="menuitemradio"> Item 2 </kumo-menu-item>
      <kumo-menu-item role="menuitemradio"> Item 3 </kumo-menu-item>
    </kumo-menu-list>
  </div>
`);
...
export const MenuListWithIcons = renderComponent(html<MenuListStoryArgs>`
  <div style="width: 128px; position: relative">
    <kumo-menu-list>
      <kumo-menu-item> Item 1 </kumo-menu-item>
      <kumo-menu-item>
        Item 2
        <span slot="start">${Edit20Filled}</span>
      </kumo-menu-item>
...
export const MenuListWithIconsAndSelection = renderComponent(html<MenuListStoryArgs>`
  <div style="width: 128px;">
    <kumo-menu-list>
      <kumo-menu-item role="menuitemcheckbox">
        Item 1
        <span slot="start">${Cut20Filled}</span>
      </kumo-menu-item>
      <kumo-menu-item role="menuitemcheckbox">
...
export const MenuListWithSubmenu = renderComponent(html<MenuListStoryArgs>`
  <div style="width: 260px;">
    <kumo-menu-list>
      ...
      <kumo-menu-item>Item 3</kumo-menu-item>
    </kumo-menu-list>
  </div>
`);
...
export const MenuListAligningWithDivider = renderComponent(html<MenuListStoryArgs>`
  <div style="width: 128px; position: relative">
    <kumo-menu-list>
      <kumo-menu-item> Item 1 </kumo-menu-item>
      <kumo-menu-item> Item 2 </kumo-menu-item>
      <fluent-divider role="separator" aria-orientation="horizontal" orientation="horizontal"></fluent-divider>

      <kumo-menu-item> Item 3 </kumo-menu-item>
      <kumo-menu-item> Item 4 </kumo-menu-item>
    </kumo-menu-list>
  </div>
`);
